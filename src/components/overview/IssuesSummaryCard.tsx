        ...
        return (
          ...
          >
            ...
            <div
              ...
              style={{
                boxShadow: isSelected ? `0 0 20px ${config.glowColor}, 0 0 40px ${config.glowColor}` : 'none',
              }}
            >
              <div
            ...
            {/* 角落装饰 - 四个角落 */}
            <div className={`absolute top-0 left-0 w-6 h-6 border-t-2 border-l-2 ${config.borderColor} rounded-tl-lg opacity-50 group-hover:opacity-100 transition-opacity`} />
            <div className={`absolute top-0 right-0 w-6 h-6 border-t-2 border-r-2 ${config.borderColor} rounded-tr-lg opacity-50 group-hover:opacity-100 transition-opacity`} />
            <div className={`absolute bottom-0 left-0 w-6 h-6 border-b-2 border-l-2 ${config.borderColor} rounded-bl-lg opacity-50 group-hover:opacity-100 transition-opacity`} />
            <div className={`absolute bottom-0 right-0 w-6 h-6 border-b-2 border-r-2 ${config.borderColor} rounded-br-lg opacity-50 group-hover:opacity-100 transition-opacity`} />
            ...
            <div className="relative p-3 pl-3">
              ...
              <div className="text-xs text-muted-foreground font-medium uppercase tracking-wide flex items-center gap-2">
                <span className={`w-1.5 h-1.5 rounded-full ${config.accentBar} ${count > 0 ? 'animate-pulse' : 'opacity-30'}`} />
